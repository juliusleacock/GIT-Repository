...
<form id="generateReport" method='POST' action="/KISS_RAADMA/Test_Punctuality_Report" class="form-inline">
	...
	<hr>
		...
		<div class="row">
			...
			<table class="table table-bordered text-center" style="border-top-color:white !important;" id="LateMinsPunctualityReport">
				<thead>
					<th colspan="4" style="border-top-color:white !important; border-left-color:white !important; border-right-color:white !important;">PUNCTUALITY REPORT WEEKLY PAID EMPLOYEES PLANT & SUPPLY CHAIN - <?php echo "$month_abbr $selected_year"; ?></th>
				</thead>
				<tr class="report_titles">
					...
					<td>Total number of Employees with 3 or more days 10 mins late or 30 mins late for month of <?php echo $month_abbr. " ".$selected_year ?></td>
				</tr>
